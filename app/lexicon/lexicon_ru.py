...
LEXICON: dict[str, str] = {
    ...
    'back_to_order_details_button': '↩️ Назад к деталям заказа', # <-- ДОБАВЛЕНО
    ...
    'change_status_button': '🔄 Изменить статус', # <-- ДОБАВЛЕНО
    'admin_choose_new_status': '👇 Выберите новый статус для заказа #{order_id}:', # <-- ДОБАВЛЕНО
