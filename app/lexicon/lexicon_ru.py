# Файл с текстовыми строками (лексиконом) для бота на русском языке

# Словарь для текстового представления статусов заказов
ORDER_STATUSES = {
    'new': 'Ожидает оплаты',
...
# Основной словарь с текстами
LEXICON: dict[str, str] = {
    # --- Пользовательская часть ---
    'start_message': 'Используй меню для навигации.',
    ...
    'checkout_final_prompt': (
        ...
        '1. Пожалуйста, переведите указанную сумму на карту (<b>{card_owner}</b>):\n'
    ...
    'report_button': '📈 Скачать отчет',
    'generating_report': '⏳ Формирую отчет... Это может занять несколько секунд.',
    'report_no_orders': 'Нет заказов для формирования отчета.',
    'report_ready': '✅ Ваш отчет по заказам готов.',
    ...
    'back_to_order_details_button': '↩️ Назад к деталям заказа',
    'admin_enter_cancellation_reason': '📝 Введите причину отмены заказа #{order_id}:',
    'admin_enter_cdek_track_number': '🚚 Введите трек-номер СДЭК для заказа #{order_id}:',
    ...
    'admin_choose_new_status': '👇 Выберите новый статус для заказа #{order_id}:',

    # --- Общие строки ---
    'back_button': '⬅️ Назад',
    'error_message': 'Что-то пошло не так. Попробуйте снова.',
    
    # --- Тексты для кнопок смены статуса ---
